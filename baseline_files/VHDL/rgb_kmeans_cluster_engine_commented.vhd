-----------------------------------------------------------------------------
-- FILE : rgb_kmeans_cluster_engine.vhd
-- Author      : Sakinder
-- DESCRIPTION
...
-- Rising edge clock detection: ensures synchronous sequential logic
    if rising_edge(clk) then
        rgbSyncValid(0)  <= pixel_in_rgb.valid;
...
-- Rising edge clock detection: ensures synchronous sequential logic
    if rising_edge(clk) then
        rgb_std1sync.red    <= pixel_in_rgb.red;
        rgb_std1sync.green  <= pixel_in_rgb.green;
        rgb_std1sync.blue   <= pixel_in_rgb.blue;
        rgb_std1sync.valid  <= pixel_in_rgb.valid;
-- End of design block
    end if;
-- End of design block
end process;
...
color_k1_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
...
color_k3_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k4_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k5_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k6_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k7_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k8_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k9_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k10_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k11_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k12_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k13_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k14_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k15_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k16clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k17_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k18_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k19_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k20_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k21_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k22_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k23_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k24_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k25_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k26_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k27_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k28_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k29_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
color_k30_clustering_inst: rgb_cluster_core
-- Generic parameters: compile‑time configuration values
generic map(
    data_width        => i_data_width)
-- Port definitions: input/output interface signals
...
-- Rising edge clock detection: ensures synchronous sequential logic
    if rising_edge(clk) then
        if ((thr5.threshold1  = threshold)) then
            pixel_out_rgb.red     <= rgb(1).red;
            pixel_out_rgb.green   <= rgb(1).gre;
            pixel_out_rgb.blue    <= rgb(1).blu;
        elsif((thr5.threshold2 = threshold)) then
            pixel_out_rgb.red     <= rgb(2).red;
            pixel_out_rgb.green   <= rgb(2).gre;
            pixel_out_rgb.blue    <= rgb(2).blu;
        elsif((thr5.threshold3 = threshold)) then
            pixel_out_rgb.red     <= rgb(3).red;
            pixel_out_rgb.green   <= rgb(3).gre;
            pixel_out_rgb.blue    <= rgb(3).blu;
        elsif((thr5.threshold4 = threshold)) then
            pixel_out_rgb.red     <= rgb(4).red;
            pixel_out_rgb.green   <= rgb(4).gre;
            pixel_out_rgb.blue    <= rgb(4).blu;
        elsif((thr5.threshold5 = threshold)) then
            pixel_out_rgb.red     <= rgb(5).red;
            pixel_out_rgb.green   <= rgb(5).gre;
            pixel_out_rgb.blue    <= rgb(5).blu;
        elsif((thr5.threshold6 = threshold)) then
            pixel_out_rgb.red     <= rgb(6).red;
            pixel_out_rgb.green   <= rgb(6).gre;
            pixel_out_rgb.blue    <= rgb(6).blu;
        elsif((thr5.threshold7 = threshold)) then
            pixel_out_rgb.red     <= rgb(7).red;
            pixel_out_rgb.green   <= rgb(7).gre;
            pixel_out_rgb.blue    <= rgb(7).blu;
        elsif((thr5.threshold8 = threshold)) then
            pixel_out_rgb.red     <= rgb(8).red;
            pixel_out_rgb.green   <= rgb(8).gre;
            pixel_out_rgb.blue    <= rgb(8).blu;
        elsif((thr5.threshold9 = threshold)) then
            pixel_out_rgb.red     <= rgb(9).red;
            pixel_out_rgb.green   <= rgb(9).gre;
            pixel_out_rgb.blue    <= rgb(9).blu;
        elsif((thr5.threshold10 = threshold)) then
            pixel_out_rgb.red     <= rgb(10).red;
            pixel_out_rgb.green   <= rgb(10).gre;
            pixel_out_rgb.blue    <= rgb(10).blu;
        elsif((thr5.threshold11 = threshold)) then
            pixel_out_rgb.red     <= rgb(11).red;
            pixel_out_rgb.green   <= rgb(11).gre;
            pixel_out_rgb.blue    <= rgb(11).blu;
        elsif((thr5.threshold12 = threshold)) then
            pixel_out_rgb.red     <= rgb(12).red;
            pixel_out_rgb.green   <= rgb(12).gre;
            pixel_out_rgb.blue    <= rgb(12).blu;
        elsif((thr5.threshold13 = threshold)) then
            pixel_out_rgb.red     <= rgb(13).red;
            pixel_out_rgb.green   <= rgb(13).gre;
            pixel_out_rgb.blue    <= rgb(13).blu;
        elsif((thr5.threshold14 = threshold)) then
            pixel_out_rgb.red     <= rgb(14).red;
            pixel_out_rgb.green   <= rgb(14).gre;
            pixel_out_rgb.blue    <= rgb(14).blu;
        elsif((thr5.threshold15 = threshold)) then
            pixel_out_rgb.red     <= rgb(15).red;
            pixel_out_rgb.green   <= rgb(15).gre;
            pixel_out_rgb.blue    <= rgb(15).blu;
        elsif((thr5.threshold16 = threshold)) then
            pixel_out_rgb.red     <= rgb(16).red;
            pixel_out_rgb.green   <= rgb(16).gre;
            pixel_out_rgb.blue    <= rgb(16).blu;
        elsif((thr5.threshold17 = threshold)) then
            pixel_out_rgb.red     <= rgb(17).red;
            pixel_out_rgb.green   <= rgb(17).gre;
            pixel_out_rgb.blue    <= rgb(17).blu;
        elsif((thr5.threshold18 = threshold)) then
            pixel_out_rgb.red     <= rgb(18).red;
            pixel_out_rgb.green   <= rgb(18).gre;
            pixel_out_rgb.blue    <= rgb(18).blu;
        elsif((thr5.threshold19 = threshold)) then
            pixel_out_rgb.red     <= rgb(19).red;
            pixel_out_rgb.green   <= rgb(19).gre;
            pixel_out_rgb.blue    <= rgb(19).blu;
        elsif((thr5.threshold20 = threshold)) then
            pixel_out_rgb.red     <= rgb(20).red;
            pixel_out_rgb.green   <= rgb(20).gre;
            pixel_out_rgb.blue    <= rgb(20).blu;
        elsif((thr5.threshold21 = threshold)) then
            pixel_out_rgb.red     <= rgb(21).red;
            pixel_out_rgb.green   <= rgb(21).gre;
            pixel_out_rgb.blue    <= rgb(21).blu;
        elsif((thr5.threshold22 = threshold)) then
            pixel_out_rgb.red     <= rgb(22).red;
            pixel_out_rgb.green   <= rgb(22).gre;
            pixel_out_rgb.blue    <= rgb(22).blu;
        elsif((thr5.threshold23 = threshold)) then
            pixel_out_rgb.red     <= rgb(23).red;
            pixel_out_rgb.green   <= rgb(23).gre;
            pixel_out_rgb.blue    <= rgb(23).blu;
        elsif((thr5.threshold24 = threshold)) then
            pixel_out_rgb.red     <= rgb(24).red;
            pixel_out_rgb.green   <= rgb(24).gre;
            pixel_out_rgb.blue    <= rgb(24).blu;
        elsif((thr5.threshold25 = threshold)) then
            pixel_out_rgb.red     <= rgb(25).red;
            pixel_out_rgb.green   <= rgb(25).gre;
            pixel_out_rgb.blue    <= rgb(25).blu;
        elsif((thr5.threshold26 = threshold)) then
            pixel_out_rgb.red     <= rgb(26).red;
            pixel_out_rgb.green   <= rgb(26).gre;
            pixel_out_rgb.blue    <= rgb(26).blu;
        elsif((thr5.threshold27 = threshold)) then
            pixel_out_rgb.red     <= rgb(27).red;
            pixel_out_rgb.green   <= rgb(27).gre;
            pixel_out_rgb.blue    <= rgb(27).blu;
        elsif((thr5.threshold28 = threshold)) then
            pixel_out_rgb.red     <= rgb(28).red;
            pixel_out_rgb.green   <= rgb(28).gre;
            pixel_out_rgb.blue    <= rgb(28).blu;
        elsif((thr5.threshold29 = threshold)) then
            pixel_out_rgb.red     <= rgb(29).red;
            pixel_out_rgb.green   <= rgb(29).gre;
            pixel_out_rgb.blue    <= rgb(29).blu;
        elsif((thr5.threshold30 = threshold)) then
            pixel_out_rgb.red     <= rgb(30).red;
            pixel_out_rgb.green   <= rgb(30).gre;
            pixel_out_rgb.blue    <= rgb(30).blu;
        else
